  ...
  return (
    <div style={{ marginBottom: 16 }}>
      ...
      {editMain && <div style={{ background: "#FAFAFA", border: "1px solid #E5E5E5", borderRadius: 10, padding: 14, borderLeft: "3px solid #0a0a0a", marginBottom: editReply ? 8 : 0 }}>
        ...
        <textarea value={editMain} onChange={e => setEditMain(e.target.value)} style={{ width: "100%", boxSizing: "border-box", fontSize: 14, color: "#333333", lineHeight: 1.9, border: "1px solid #E5E5E5", borderRadius: 8, padding: 10, background: "#FFFFFF", resize: "vertical", minHeight: 80, fontFamily: "inherit", outline: "none" }} />
      </div>}
      {editReply && <div style={{ marginLeft: 16, background: "#FAFAFA", border: "1px solid #E5E5E5", borderRadius: 10, padding: 14, borderLeft: "3px solid #83c2cb" }}>
        ...
        <textarea value={editReply} onChange={e => setEditReply(e.target.value)} style={{ width: "100%", boxSizing: "border-box", fontSize: 14, color: "#333333", lineHeight: 1.9, border: "1px solid #E5E5E5", borderRadius: 8, padding: 10, background: "#FFFFFF", resize: "vertical", minHeight: 80, fontFamily: "inherit", outline: "none" }} />
      </div>}
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,.7)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9998, padding: 16 }}>
      <div style={{ background: "#FAFAFA", borderRadius: 14, padding: 24, width: "100%", maxWidth: 360 }}>
        ...
        <div style={{ fontSize: 11, color: "#888", marginBottom: 16, lineHeight: 1.6 }}>※ 投稿は1日1回（毎日午前9時）にまとめて実行されます。指定日時を過ぎた投稿が次の実行タイミングで投稿されます。</div>
          ...
          {result.rewrite && (
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <div style={{ background: "#FAFAFA", border: "1px solid #E5E5E5", borderRadius: 10, padding: 14, borderLeft: "3px solid #0a0a0a" }}>
                ...
                <textarea value={editMain} onChange={e => setEditMain(e.target.value)} style={{ width: "100%", boxSizing: "border-box", fontSize: 14, color: "#333333", lineHeight: 1.9, border: "1px solid #E5E5E5", borderRadius: 8, padding: 12, background: "#FFFFFF", resize: "vertical", minHeight: 120, fontFamily: "inherit", outline: "none" }} />
              </div>
              {editReply && (
                <div style={{ marginLeft: 16, background: "#FAFAFA", border: "1px solid #E5E5E5", borderRadius: 10, padding: 14, borderLeft: "3px solid #83c2cb" }}>
                  ...
                  <textarea value={editReply} onChange={e => setEditReply(e.target.value)} style={{ width: "100%", boxSizing: "border-box", fontSize: 14, color: "#333333", lineHeight: 1.9, border: "1px solid #E5E5E5", borderRadius: 8, padding: 12, background: "#FFFFFF", resize: "vertical", minHeight: 120, fontFamily: "inherit", outline: "none" }} />
                </div>
              )}
          ...
          {result.appeals?.map((appeal, i) => (
            <div key={i} onClick={() => setSelectedIndex(i)} style={{
              ...
              <div onClick={e => e.stopPropagation()}>
                <textarea value={getEditedContent(i)} onChange={e => setEditedAppeals(prev => ({ ...prev, [i]: e.target.value }))} style={{ width: "100%", boxSizing: "border-box", fontSize: 14, color: "#1A1A1A", lineHeight: 1.9, background: "#FFFFFF", borderRadius: 8, padding: 12, border: "1px solid #E5E5E5", borderLeft: "3px solid #0a0a0a", resize: "vertical", minHeight: 100, fontFamily: "inherit", outline: "none" }} />
              </div>
