...
function TabB1({ onSelectAppeal, onSchedule, useCredit, styleProfile, onStyleChange }) {
  ...
  return (
    <div>
      ...
      <Err msg={error} />
      {loading && <><LoadingIndicator message="記事を分析中（しばらくお待ちください）" /><div style={{ textAlign: "center", fontSize: 12, color: "#888", marginTop: 8 }}>記事の文量が多ければ多いほど、時間がかかります。しばらくお待ちください。</div></>}
