...
function Card({ index, main, reply, hooks, onSave, onSchedule }) {
  ...
  return (
    <div style={{ marginBottom: 16 }}>
      ...
      {editMain && <div style={{ background: "#FAFAFA", border: "1px solid #E5E5E5", borderRadius: 10, padding: 14, borderLeft: "3px solid #0a0a0a", marginBottom: editReply ? 8 : 0 }}>
        ...
        <textarea value={editMain} onChange={e => setEditMain(e.target.value)} style={{ width: "100%", maxWidth: 280, boxSizing: "border-box", fontSize: 14, color: "#333333", lineHeight: 1.9, border: "1px solid #E5E5E5", borderRadius: 8, padding: 10, background: "#FFFFFF", resize: "vertical", minHeight: editReply ? 80 : 120, fontFamily: "inherit", outline: "none" }} />
      </div>}
      {editReply && <div style={{ marginLeft: 16, background: "#FAFAFA", border: "1px solid #E5E5E5", borderRadius: 10, padding: 14, borderLeft: "3px solid #83c2cb" }}>
        ...
        <textarea value={editReply} onChange={e => setEditReply(e.target.value)} style={{ width: "100%", maxWidth: 280, boxSizing: "border-box", fontSize: 14, color: "#333333", lineHeight: 1.9, border: "1px solid #E5E5E5", borderRadius: 8, padding: 10, background: "#FFFFFF", resize: "vertical", minHeight: 250, fontFamily: "inherit", outline: "none" }} />
      </div>}
        ...
        <div style={{ marginTop: 28 }}>
          ...
          {result.rewrite && (
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <div style={{ background: "#FAFAFA", border: "1px solid #E5E5E5", borderRadius: 10, padding: 14, borderLeft: "3px solid #0a0a0a" }}>
                ...
                <textarea value={editMain} onChange={e => setEditMain(e.target.value)} style={{ width: "100%", maxWidth: 320, boxSizing: "border-box", fontSize: 14, color: "#333333", lineHeight: 1.9, border: "1px solid #E5E5E5", borderRadius: 8, padding: 12, background: "#FFFFFF", resize: "vertical", minHeight: editReply ? 80 : 300, fontFamily: "inherit", outline: "none" }} />
              </div>
              {editReply && (
                <div style={{ marginLeft: 16, background: "#FAFAFA", border: "1px solid #E5E5E5", borderRadius: 10, padding: 14, borderLeft: "3px solid #83c2cb" }}>
                  ...
                  <textarea value={editReply} onChange={e => setEditReply(e.target.value)} style={{ width: "100%", maxWidth: 320, boxSizing: "border-box", fontSize: 14, color: "#333333", lineHeight: 1.9, border: "1px solid #E5E5E5", borderRadius: 8, padding: 12, background: "#FFFFFF", resize: "vertical", minHeight: 400, fontFamily: "inherit", outline: "none" }} />
                </div>
              )}
