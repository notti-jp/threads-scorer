...
function TabA({ onSaveDraft, onSchedule, draftEdit, styleProfile, onStyleChange, knowledgePriority, onKnowledgeChange, appealText, onClearAppeal, useCredit, username }) {
  ...
  return (
    <div>
      ...
      <Err msg={error} />
      {loading && <><LoadingIndicator message={isAppeal ? "素案から投稿文を生成中..." : "採点中（しばらくお待ちください）"} /><div style={{ textAlign: "center", fontSize: 12, color: "#888", marginTop: 8 }}>生成後にAIが品質チェックを行うため、少し時間がかかる場合があります。</div></>}
      {result && (
