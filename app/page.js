...
// ═══════ タブB1：note魅力抽出 ═══════
function TabB1({ onSelectAppeal, useCredit }) {
...
// ═══════ タブB2 ═══════
function TabB2({ onSaveDraft, styleProfile, useCredit }) {
  const [file, setFile] = useState(null);
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState(null);
  const [error, setError] = useState("");
    ...
    return (
      <div style={{ minHeight: "100vh", background: "#FFFFFF", color: "#1A1A1A", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Hiragino Sans', sans-serif", display: "flex", alignItems: "center", justifyContent: "center", padding: 16, overflowX: "hidden", width: "100%", maxWidth: "100vw" }}>
        <div style={{ width: "100%", maxWidth: 380, textAlign: "center" }}>
          <div style={{ fontSize: 12, letterSpacing: 4, color: "#666666", textTransform: "uppercase", marginBottom: 6 }}>Notti</div>
          <h1 style={{ fontSize: 26, fontWeight: 700, margin: "0 0 24px", background: "linear-gradient(135deg, #0a0a0a, #83c2cb)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Notti「欲しい」メーカー</h1>
    ...
    <div style={{ minHeight: "100vh", background: "#FFFFFF", color: "#1A1A1A", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Hiragino Sans', sans-serif", padding: "32px 16px", overflowX: "hidden", width: "100%", maxWidth: "100vw" }}>
      <div style={{ maxWidth: 560, margin: "0 auto" }}>
        <div style={{ marginBottom: 24, textAlign: "center" }}>
          <div style={{ fontSize: 12, letterSpacing: 4, color: "#666666", textTransform: "uppercase", marginBottom: 6 }}>Notti</div>
          <h1 style={{ fontSize: 26, fontWeight: 700, margin: 0, background: "linear-gradient(135deg, #0a0a0a, #83c2cb)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Notti「欲しい」メーカー</h1>
        ...
        {screen === "profile" ? (
          ...
          <>
            ...
            {tab === "A" && <TabA onSaveDraft={handleSaveDraft} draftEdit={draftEdit} styleProfile={styleProfile} onStyleChange={() => setShowStyleDialog(true)} knowledgePriority={knowledgePriority} onKnowledgeChange={handleNozzleChange} appealText={appealText} onClearAppeal={() => setAppealText("")} useCredit={useCredit} />}
            {tab === "B1" && <TabB1 onSelectAppeal={handleSelectAppeal} useCredit={useCredit} />}
            {tab === "B2" && <TabB2 onSaveDraft={handleSaveDraft} styleProfile={styleProfile} useCredit={useCredit} />}
