...
export default function Home() {
  ...
  useEffect(() => { fetch("/api/announcements").then(r => r.json()).then(d => { setAnnouncement(d.message); setAnnouncementType(d.type); }).catch(() => {}); }, []);
    ...
    return (
      <div style={{ minHeight: "100vh", background: "#FFFFFF", color: "#1A1A1A", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Hiragino Sans', sans-serif", display: "flex", alignItems: "center", justifyContent: "center", padding: 16, overflowX: "hidden", width: "100%", maxWidth: "100vw" }}>
        <div style={{ width: "100%", maxWidth: 380, textAlign: "center" }}>
          ...
          {announcement && announcementType === "memo" && <div style={{ marginBottom: 16, position: "relative", padding: "12px 16px", background: "#F8F8F8", borderRadius: 12, fontSize: 13, color: "#555", lineHeight: 1.7, textAlign: "left" }}><span style={{ fontWeight: 600, color: "#0a0a0a" }}>一言メモ：</span>{announcement}</div>}
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#FFFFFF", color: "#1A1A1A", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Hiragino Sans', sans-serif", padding: "20px 16px", overflowX: "hidden", width: "100%", maxWidth: "100vw" }}>
      <div style={{ maxWidth: 560, margin: "0 auto" }}>
        ...
        {screen === "profile" ? (
          ...
          <>
            ...
            {announcement && announcementType === "memo" && <div style={{ marginBottom: 14, position: "relative", padding: "12px 16px 12px 20px", background: "#F8F8F8", borderRadius: 12, borderLeft: "3px solid #83c2cb", fontSize: 13, color: "#555", lineHeight: 1.7 }}><span style={{ fontWeight: 600, color: "#0a0a0a" }}>一言メモ：</span>{announcement}</div>}
      ...
      <div style={{ maxWidth: 560, margin: "40px auto 0", padding: "20px 0", borderTop: "1px solid #E5E5E5", display: "flex", justifyContent: "center", gap: 16, fontSize: 12 }}>
        <a href="/privacy" style={{ color: "#888", textDecoration: "none" }}>プライバシーポリシー</a>
        <a href="/terms" style={{ color: "#888", textDecoration: "none" }}>利用規約</a>
        <a href="/contact" style={{ color: "#888", textDecoration: "none" }}>お問い合わせ</a>
      </div>
