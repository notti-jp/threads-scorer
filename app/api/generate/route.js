...
import { B1_PROMPT, B2_PROMPT, B1_HOOK_CANDIDATES_INSTRUCTION, buildStyleInstruction } from "../../prompts";
...
export async function POST(request) {
  ...
  try {
    ...
    const styleProfileText = formData.get("styleProfile"); // [変更: v2.5]
    ...
    prompt += buildStyleInstruction(styleProfileText); // [変更: v2.5]
