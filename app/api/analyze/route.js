...
export async function POST(request) {
  ...
  try {
    ...
    const modeInstructions = {
      ...
      tree: `以下のThreads投稿を採点してください。リライトは「本投稿＋リプ」モードで出力してください。本投稿は1-3行、リプは原則10行以内に収めること`,
      treeShort: `以下のThreads投稿を採点してください。リライトは「本投稿＋リプ・簡潔版」モードで出力してください。本投稿は1-3行、リプは原則8行以内に収めること。短いながらも冒頭のフックと具体性は維持する`,
    };
