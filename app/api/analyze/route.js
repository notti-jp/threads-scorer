...
import { SCORE_PROMPT, HOOK_CANDIDATES_INSTRUCTION, buildStyleInstruction, buildKnowledgePriority } from "../../prompts";
...
export async function POST(request) {
  ...
  try {
    const { text, mode, useHook, styleProfile, knowledgePriority } = await request.json();
    ...
    system += buildKnowledgePriority(knowledgePriority); // [変更: v2.5]
