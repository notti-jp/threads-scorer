...
import { SCORE_PROMPT, HOOK_CANDIDATES_INSTRUCTION, buildStyleInstruction } from "../../prompts";
...
export async function POST(request) {
  ...
  try {
    const { text, mode, useHook, styleProfile } = await request.json();
    ...
    system += buildStyleInstruction(styleProfile); // [変更: v2.5]
